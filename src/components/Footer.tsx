        ...
        <div className="container-width">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/80 leading-relaxed">
                WhatsApp automation made simple. Chatflow is a product of Amazing Developers Pty Ltd, helping businesses transform customer communication with AI-powered chat solutions.
              </p>
              <div className="flex items-center gap-4">
                <a href="https://wa.me/61430454071" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-whatsapp-green transition-colors">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-white/80">
                ...
                <li><Link to="/legal" className="hover:text-whatsapp-green transition-colors">Legal</Link></li>
              </ul>
            </div>

            {/* Contact - Australian Office */}
            <div className="space-y-4">
              <h3 className="font-semibold text-lg">Contact (Australian Office)</h3>
              <div className="space-y-3 text-white/80">
                <div className="flex items-start gap-3">
                  <MapPin className="h-5 w-5 text-whatsapp-green flex-shrink-0 mt-0.5" />
                  <span>8 Juneberry Dr, Keysborough VIC 3173, Australia</span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="h-5 w-5 text-whatsapp-green flex-shrink-0" />
                  <a href="tel:0430454071" className="hover:text-whatsapp-green transition-colors">0430 454 071</a>
                </div>
                <div className="flex items-center gap-3">
                  <Mail className="h-5 w-5 text-whatsapp-green flex-shrink-0" />
                  <a href="mailto:hello@thechatflow.com" className="hover:text-whatsapp-green transition-colors">hello@thechatflow.com</a>
                </div>
              </div>
          ...
          <div className="mt-10 pt-8 border-t border-white/10">
            <div className="text-white/60 text-sm space-y-1">
              <p className="font-medium text-white/80">Chatflow is a product operated by Amazing Developers Pty Ltd. ABN: 97 670 956 055. ACN: 670 956 055.</p>
              <p>Registered office: 8 Juneberry Dr, Keysborough VIC 3173, Australia</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container-width py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-wrap items-center gap-6 text-sm text-white/60">
              <span>© 2025 Amazing Developers Pty Ltd. All rights reserved.</span>
              ...
              <Link to="/legal" className="hover:text-whatsapp-green transition-colors">Legal</Link>
            </div>
