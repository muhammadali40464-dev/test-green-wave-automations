                ...
                <div className="section-padding">
                        <div className="container-width">
                                  <div className="grid md:grid-cols-3 gap-8">
                                    {/* Brand */}
                                              <div className="space-y-4">
                                                            <div className="flex items-center gap-2">
                                                                            ...
                                                                            <span className="font-bold text-xl">TheChatFlow.com</span>span>
                                                            </div>div>
                                    ...
                                    {/* Navigation */}
                                              <div className="space-y-4">
                                                            <h3 className="font-semibold text-lg">Navigation</h3>h3>
                                                            <ul className="space-y-2 text-white/80">
                                                                            <li><Link to="/" className="hover:text-whatsapp-green transition-colors">Home</Link>Link></li>li>
                                                                            <li><Link to="/blog" className="hover:text-whatsapp-green transition-colors">Blog</Link>Link></li>li>
                                                                            <li><Link to="/success-stories" className="hover:text-whatsapp-green transition-colors">Success Stories</Link>Link></li>li>
                                                                            <li><Link to="/contact" className="hover:text-whatsapp-green transition-colors">Contact Us</Link>Link></li>li>
                                                                            <li><Link to="/legal" className="hover:text-whatsapp-green transition-colors">Legal Information</Link>Link></li>li>
                                                            </ul>ul>
                                              </div>div>
                                  
                                    {/* Contact */}
                                              <div className="space-y-4">
                                                            <h3 className="font-semibold text-lg">Contact</h3>h3>
                                                            <div className="space-y-3 text-white/80">
                                                                            <div className="flex items-center gap-3">
                                                                                              <Phone className="h-5 w-5 text-whatsapp-green flex-shrink-0" />
                                                                                              <span>+92 317 1634191</span>span>
                                                                            </div>div>
                                                                            <div className="flex items-center gap-3">
                                                                                              <Mail className="h-5 w-5 text-whatsapp-green flex-shrink-0" />
                                                                                              <span>hello@thechatflow.com</span>span>
                                                                            </div>div>
                                                                            <div className="flex items-center gap-3">
                                                                                              <MapPin className="h-5 w-5 text-whatsapp-green flex-shrink-0" />
                                                                                              <span>Lahore, Pakistan</span>span>
                                                                            </div>div>
                                                            </div>div>
                                                            <div className="bg-white/15 border border-white/20 rounded-2xl p-6 space-y-4">
                                                                            <h4 className="font-bold text-xl text-white">Need Help?</h4>h4>
                                                                            <p className="text-lg text-white/90 font-medium">Our support team replies in minutes</p>p>
                                                                            <Link to="/contact">
                          ...
                          {/* Legal Information */}
                                  <div className="mt-10 pt-8 border-t border-white/10">
                                              <div className="text-white/60 text-sm space-y-1">
                                                            <p className="font-medium text-white/80">Chatflow is operated by Amazing Developers Pty Ltd. ABN: 97 670 956 055. ACN: 670 956 055.</p>p>
                                                            <p>Registered office: 8 Juneberry Dr, Keysborough VIC 3173, Australia</p>p>
                                              </div>div>
                                  </div>div>
                        </div>div>
                </div>div>
                        ...
                        <div className="container-width py-6">
                                  <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                                              <div className="flex flex-wrap items-center gap-6 text-sm text-white/60">
                                                            <span>© 2025 Ali Tahir. All rights reserved.</span>span>
                                                            <Link to="/privacy-policy" className="hover:text-whatsapp-green transition-colors">Privacy Policy</Link>Link>
                                                            <Link to="/terms-of-service" className="hover:text-whatsapp-green transition-colors">Terms of Service</Link>Link>
                                                            <Link to="/cookie-policy" className="hover:text-whatsapp-green transition-colors">Cookie Policy</Link>Link>
                                                            <Link to="/legal" className="hover:text-whatsapp-green transition-colors">Legal Information</Link>Link>
                                              </div>div>
                                              <div className="flex items-center gap-2 text-sm text-white/60">
                                                            <span>Made with ❤️ in Pakistan</span>span>
                                              </div>div>
                                  </div>div>
                        </div>div>
                </div>div>
