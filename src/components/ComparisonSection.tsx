      ...
      <div className="container-width">
        <div className="text-center space-y-4 mb-16">
          ...
          <h2 className="font-h1 text-foreground">
            The WhatBot vs Others
          </h2>
          
          <p className="font-body-lg text-muted-foreground max-w-2xl mx-auto">
            See why thousands of Pakistani businesses choose WhatBot over alternatives
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-3xl shadow-card border overflow-hidden">
            {/* Header */}
            <div className="bg-gradient-to-r from-yellow-400 to-orange-400 grid grid-cols-3 p-6">
              <div className="font-h3 text-gray-800">FEATURE</div>
              <div className="font-h3 text-gray-800 text-center">THE WHATBOT</div>
              <div className="font-h3 text-gray-800 text-center">OTHERS</div>
            </div>
            ...
            {features.map((feature, index) => (
              <div 
                key={index} 
                className={`grid grid-cols-3 p-6 border-b border-gray-100 items-center hover:bg-gray-50/50 transition-colors ${
                  index % 2 === 0 ? 'bg-gray-50/30' : 'bg-white'
                }`}
              >
                <div className="font-body font-medium text-gray-800">{feature}</div>
