...
const ContactUs = () => {
    ...
    const [submissionDetails, setSubmissionDetails] = useState({ customerName: "", referenceId: "" });
    ...
    const onSubmit = async (data: ContactFormData) => {
          ...
          try {
                  ...
                  const submissionData: SubmissionData = { ...data, ...enhancedData };
    ...
    const handleSuccessClose = () => {
          ...
          setSubmissionDetails({ customerName: "", referenceId: "" });
    };

    const teamFeatures = [
      { icon: Users, title: "Pakistani Team", description: "Local expertise with cultural understanding" },
      { icon: MessageCircle, title: "Urdu & English Support", description: "Communicate in your preferred language" },
      { icon: Zap, title: "Rapid Response", description: "Reply in minutes" },
      { icon: Star, title: "5-Star Support", description: "95% customer satisfaction rating" },
        ];
