      ...
      <section className="py-20">
        <div className="container-width">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-6">Multiple Ways to Connect</h2>
            ...
            {contactMethods.map((method, index) => (
              <Card key={index} className="border-0 shadow-xl hover:shadow-2xl transition-all hover-lift">
                <CardContent className="p-8 text-center">
                  ...
                  <Button 
                    className={`w-full ${method.color} hover:opacity-90 text-white font-semibold py-3`}
                  >
                    {method.action}
                  </Button>
                </CardContent>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 bg-whatsapp-green/10 rounded-2xl">
                      <Clock className="h-6 w-6 text-whatsapp-green" />
                    </div>
                ...
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-foreground">Emergency Support</h3>
                  </div>
                  ...
                  <div className="bg-blue-50 rounded-xl p-6">
                    ...
                    <div className="flex items-center gap-2 text-blue-600">
                      ...
                      <span className="font-medium">WhatsApp emergency line available</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container-width">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-8">
                <h3 className="text-xl font-bold text-foreground mb-4">How quickly can you respond?</h3>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-8">
                <h3 className="text-xl font-bold text-foreground mb-4">Do you offer free consultations?</h3>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-8">
                <h3 className="text-xl font-bold text-foreground mb-4">Can you help with setup and training?</h3>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-8">
                <h3 className="text-xl font-bold text-foreground mb-4">What industries do you specialize in?</h3>
                <p className="text-muted-foreground leading-relaxed">
